...
class FormAddCategory extends QBForm<FormAddCategoryProps> {
    constructor(props: FormAddCategoryProps) {
        super(props);
    }
                    ...
                    <form class="flex flex-col gap-3 w-[500px]">
                        ...
                        <div class="relative">
                         ...
                         <div class="flex gap-3">
                            <button class="btn-save w-full p-3 bg-blue-600 text-white rounded-lg border-none focus:ring-gray-300 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-400">Create</button>
